...
public class TicTacToeF extends javax.swing.JFrame {
    ...
    private void winningGame()
    {
        ...
        if(b1 == ("X") && b2 == ("X") && b3 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player Atharva Win","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
            xcount++;
            gameScore();
        ...
        {
            JOptionPane.showMessageDialog(this, "Player Abhishek Win","Tic Tac Toe",JOptionPane.INFORMATION_MESSAGE);
            ocount++;
            gameScore();
    ...
    private void initComponents() {
        ...
        playero.setText("Player Abhishek : ");

        playerx.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        playerx.setText("Player atharva : ");
